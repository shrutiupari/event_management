...
<html lang="en">
<head>
<title>Welcome - <?php echo ucfirst($userRow['firstName']); ?></title>
					...
					<nav class="navbar navbar-default">
						...
						<div class="navbar-header">
							...
							<div class="agileits-logo">
								<h1><a href="home.php"><img src="images/logo1.png" alt="" /> Rock Music</a></h1>
							</div>
						</div>
							...
							<nav>
								<ul class="nav navbar-nav">
									...
									<li class="dropdown">
										...
										<span class="glyphicon glyphicon-user"></span>&nbsp;Hi' <?php echo ucfirst($userRow['firstName']); ?> <?php echo ucfirst($userRow['lastName']); ?>&nbsp;<span class="caret"></span></a>
					...
					<div id="myTabContent" class="tab-content">
							...
							<div class="w3_tab_img">
								...
								<div class="col-sm-3 w3_tab_img_left">
									...
									<div class="agile-gallery-info">
										<h5>Concert</h5>
                                                                                <a href="event.php"> Description </a><button style="border-radius: 10px; background-color:white; border:1px solid black; text-decoration: none; margin-left:60px; height:40px;" type="submit" ><a href="login.php">Book Tickets</a></button>
									</div>
								</div>
								
								<?php	
									$qry="select * from images where eid='2'";
									$result = mysql_query($qry);
									$row = mysql_fetch_array($result);
								?>
								...
								<?php	
									$qry="select * from images where eid='3'";
									$result = mysql_query($qry);
									$row = mysql_fetch_array($result);
								?>
								...
								<?php	
									$qry="select * from images where eid='4'";
									$result = mysql_query($qry);
									$row = mysql_fetch_array($result);
								?>
								...
								<?php	
									$qry="select * from images where eid='5'";
									$result = mysql_query($qry);
									$row = mysql_fetch_array($result);
								?>
								...
								<?php	
									$qry="select * from images where eid='6'";
									$result = mysql_query($qry);
									$row = mysql_fetch_array($result);
								?>
								...
								<?php	
									$qry="select * from images where eid='7'";
									$result = mysql_query($qry);
									$row = mysql_fetch_array($result);
								?>
						...
						<div role="tabpanel" class="tab-pane fade" id="painting" aria-labelledby="painting-tab">
							<div class="w3_tab_img">
								...
								<?php	
									$qry="select * from images where e='1'";
									$result = mysql_query($qry);
									$row = mysql_fetch_array($result);
								?>
